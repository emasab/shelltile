...
var WindowGroup = function (first, second, type, splitPercent){
    ...
    this.update_split_percent = function (bounds, changed, changed_rect){
    ...
    this.update_geometry = async function (win, win_rect){
